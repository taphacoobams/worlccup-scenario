...
import { glassPanelStatic, inputMinimal } from "@/lib/ui-classes";
...
export function ScenarioFilters({
  ...
  return (
    <div className={cn(glassPanelStatic, "p-4 space-y-4")}>
      <div className="relative">
        ...
        <input
          ...
          className={cn(inputMinimal, "w-full pl-10 pr-4 py-2")}
